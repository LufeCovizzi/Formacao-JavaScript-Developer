...
let valorATransferir = valorSalarioBruto - (calcularPorcentagem(valorSalarioBruto,pegarPercentualImpostoComBaseNoSalario(valorSalarioBruto))) + valorAdicionalDosBeneficios
